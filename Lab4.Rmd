...
logis_dat_train %>%
  kbl(caption = "Confusion matrix for the glm model train set",) %>%
  kable_material_dark("hover",full_width = F)
logis_dat_test %>%
  kbl(caption = "Confusion matrix for the glm model, test set",) %>%
  kable_material_dark("hover",full_width = F)

rand_fors_dat_train %>%
  kbl(caption = "Confusion matrix for the random forest model,train set",) %>%
  kable_material_dark("hover",full_width = F)
rand_fors_dat_test %>%
  kbl(caption = "Confusion matrix for the random forest model, test set",) %>%
  kable_material_dark("hover",full_width = F)
```
